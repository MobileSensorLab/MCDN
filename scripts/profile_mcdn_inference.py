...
Deployment-mode usage:
    uv run python -m scripts.profile_mcdn_inference --deployment \
        --checkpoint-dir outputs/ablation/all_features/Hurricane_Idalia+Hurricane_Michael+Mayfield_Tornado+Mussett_Bayou_Fire/seed_00 \
...
DEFAULT_CHECKPOINT_DIR = Path("outputs/ablation/all_features/Hurricane_Idalia+Hurricane_Michael+Mayfield_Tornado+Mussett_Bayou_Fire/seed_00")
